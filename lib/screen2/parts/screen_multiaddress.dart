...
class _MultiaddressToScreen extends State<MultiaddressToScreen> {
  ...
  Widget build(BuildContext context) {
    positionsList.clear();
    int routeCount = widget.model.appState.structAddressTod.length;
    for (int i = 0; i < routeCount; i++) {
      positionsList.add(MediaQuery.sizeOf(context).height -
          20 -
    ...
    return Stack(
      children: [
        ...
        for (int i = 0;
            i < widget.model.appState.structAddressTod.length;
            i++) ...[
          Positioned(
              top: positionsList[i],
              child: Draggable(
                ...
                onDragEnd: (d) {
                  ...
                  if (diff.abs() > 15) {
                    ...
                    AddressStruct a = widget.model.appState.structAddressTod[i];
                    widget.model.appState.structAddressTod[i] = widget
                        .model.appState.structAddressTod[steps]
                        .copyWith();
                    widget.model.appState.structAddressTod[steps] =
                        a.copyWith();
                    setState(() {});
                  }
                },
        ...
        child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    widget.model.appState.structAddressTod[i].title,
                    maxLines: 2,
                ...
                Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          widget.model.appState.structAddressTod
                              .removeAt(i);
                          setState(() {});
                        },
